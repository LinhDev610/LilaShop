...
import com.lila_shop.backend.constant.CloudinaryFolderConstants;
...
public class FileStorageService {
    ...
    public String storeVoucherMedia(MultipartFile file) {
        return uploadToCloudinary(file, CloudinaryFolderConstants.VOUCHER_MEDIA_FOLDER);
    }

    public String storePromotionMedia(MultipartFile file) {
        return uploadToCloudinary(file, CloudinaryFolderConstants.PROMOTION_MEDIA_FOLDER);
    }
    ...
    public String storeBannerMedia(MultipartFile file) {
        return uploadToCloudinary(file, CloudinaryFolderConstants.BANNER_MEDIA_FOLDER);
    }
